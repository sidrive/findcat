package com.ketukang.findcat.utils;
...
/**
 * Created by rioswarawan on 5/8/17.
 */
...
public class RxPermissions {
     ...
     * every time user grants or denies permissions. Use
    ...
    private static FuncN<Boolean> RESULT_CHECKER = results -> {
